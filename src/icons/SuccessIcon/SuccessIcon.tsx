...
import { SuccessIconProps } from './SuccessIcon.types';

const SuccessIcon = ({size='sm', color='##FFFFFF'}: SuccessIconProps) => {
	const sizesOptions = {
		sm: 24,
		md: 36,
		lg: 48,
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={sizesOptions[size]} height={sizesOptions[size]} viewBox="0 0 1024 1024">
