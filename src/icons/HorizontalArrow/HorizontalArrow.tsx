...
const HorizontalArrow = ({size='md', color='#FFFFFF'}: HorizontalArrowProps) => {
	const sizesOptions = {
		sm: 8,
		md: 12,
		lg: 16,
	...
	return (
		<svg height={sizesOptions[size]} viewBox="0 0 26 12" fill={color} xmlns="http://www.w3.org/2000/svg">
